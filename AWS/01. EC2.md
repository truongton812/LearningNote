...
Compute Savings Plan và EC2 Instance Savings Plan đều yêu cầu cam kết mức chi tiêu USD/giờ trong 1 hoặc 3 năm để được giảm giá, nhưng khác nhau chủ yếu ở mức linh hoạt và tỷ lệ discount.​

Compute Savings Plan
-Áp dụng cho mọi EC2 (mọi family, size, OS, tenancy, Region) và cả Fargate, Lambda; miễn là là dịch vụ compute thuộc phạm vi plan.​

-Linh hoạt đổi instance family (C → M → R), đổi Region, đổi từ EC2 sang Fargate/Lambda mà vẫn giữ được discount (tối đa ~66% so với On‑Demand).​

EC2 Instance Savings Plan
-Chỉ áp dụng cho một instance family cụ thể trong một Region (ví dụ toàn bộ M5 ở us-east-1), nhưng không giới hạn size, AZ, OS, tenancy trong family đó.​

-Ít linh hoạt hơn (không cover Fargate/Lambda, không đổi được sang family khác) nhưng discount cao hơn, có thể lên đến ~72% so với On‑Demand

...
- Có thể chỉ định nhiều capacity provider cho một ECS cluster và thiết lập strategy ưu tiên sử dụng từng loại khi khởi động service/task.
- Khi tạo ECS Service/task, bạn được chọn 1 hoặc nhiều capacity provider trong phần strategy, đặt weight và base cho từng loại.​

...
Khi tạo Cloud Run service trong phần networking, hai tùy chọn "send traffic directly to a VPC" và "use Serverless VPC Access connector" có sự khác biệt chính như sau:

- "Send traffic directly to a VPC" (Direct VPC egress) cho phép Cloud Run service gửi lưu lượng trực tiếp đến mạng VPC mà không cần dùng connector. Đây là cách mới hơn, dễ cấu hình hơn, có hiệu suất cao hơn với độ trễ thấp và băng thông lớn hơn. Nó còn hỗ trợ gán network tags cho từng revision dịch vụ, giúp kiểm soát bảo mật mạng chi tiết hơn. Ngoài ra, chi phí tính chỉ dựa vào lưu lượng mạng, tự động scale về 0 khi không có traffic.​

- "Use Serverless VPC Access connector" là cách truyền thống, tạo một connector để làm cầu nối giữa Cloud Run và VPC. Connector này tạo 1 dải địa chỉ IP riêng và VM instances để xử lý lưu lượng. Nó có thể bị hạn chế băng thông, tỷ lệ scale chậm hơn và áp dụng firewall rules trên toàn connector thay vì trên từng service revision riêng biệt.

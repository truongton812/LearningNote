...
Cho frontend Cloud Run gọi qua VPC: Frontend Cloud Run﻿ muốn gọi PSC endpoint cần Direct VPC Egress﻿ hoặc VPC connector﻿ trỏ vào consumer VPC đó.​ ( VPC connector/direct VPC egress﻿ giúp Frontend Cloud Run gửi được traffic vào VPC, do khi tạo GraphQL cloud run ta chọn type ingress=internal-and-cloud-load-balancing -> chỉ traffic từ vpc hoặc LB mới đi vào graphQL service được)

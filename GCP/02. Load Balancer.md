...
- Các tính năng của load balancer:
  - Healthcheck: chỉ route traffic đến healthy instances
...
- Load balancer trong GCP có các type:
  - HTTP(S) Load Balancing. Có 2 type là classic và advanced
...
- Các khái niệm khi tạo LB:
  - Backend: là nhóm các endpoints (VD instance groups) nhận traffic từ LB. Có thể config nhiều backend đứng sau 1 LB. VD khi dùng microservice thì mỗi microservice sẽ tương ứng với 1 backend

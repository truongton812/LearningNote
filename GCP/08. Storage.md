...
- Các điều kiện có thể áp dụng bao gồm: tuổi của đối tượng (tính từ ngày tạo), trạng thái hoạt động của đối tượng (live hay không), lớp lưu trữ hiện tại, tên đối tượng theo tiền tố hoặc hậu tố, hoặc thời gian tùy chỉnh. Hành động chính gồm xoá đối tượng hoặc thay đổi lớp lưu trữ để giảm chi phí.
- Tính năng Object Lifecycle Management﻿ trong Google Cloud Storage được cấu hình ở cấp độ bucket

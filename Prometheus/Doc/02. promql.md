...
Giả sử bạn có nhiều CPU (cpu0, cpu1, cpu2...) trên mỗi máy chủ (instance). Mỗi cái CPU này sẽ có một dòng số liệu riêng trong metric node_cpu_seconds_total với nhãn cpu.
